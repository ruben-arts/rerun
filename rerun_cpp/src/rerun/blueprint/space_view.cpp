...
namespace rerun {
    namespace blueprint {
        const std::shared_ptr<arrow::DataType> &SpaceView::arrow_datatype() {
        ...
        Result<std::shared_ptr<arrow::StructBuilder>> SpaceView::new_arrow_array_builder(
        ...
        Error SpaceView::fill_arrow_array_builder(
            arrow::StructBuilder *builder, const SpaceView *elements, size_t num_elements
        ) {
            if (!builder) {
